...
void Brick::initMesh(const Color clr, const Color clr2, const bool top, const bool right, const bool bottom, const bool left){
	...
	if (right)
	{
		diffRight = 1;
		tempm.normal(0.2, 0.8, 0.2);
		ad1 = tempm.vertex(pmax.x - side_weight_x, pmin.y, 0);
		tempm.normal(1, 1, 1);
		ad2 = tempm.vertex(pmax);
		tempm.normal(0.2, -0.8, 0.2);
		ad3 = tempm.vertex(pmax.x - side_weight_x, pmax.y, 0);
		tempm.normal(1, 1, 1);
		ad4 = tempm.vertex(pmax.x, pmin.y, 0);
	...
	if (left)
	{
		diffLeft = 1;
		tempm.normal(1, 1, 1);
		ag1 = tempm.vertex(pmin);
		tempm.normal(-0.2, -0.8, 0.2);
		ag2 = tempm.vertex(pmin.x + side_weight_x, pmax.y, 0);
		tempm.normal(1, 1, 1);
		ag3 = tempm.vertex(pmin.x, pmax.y, 0);
		tempm.normal(-0.2, 0.8, 0.2);
		ag4 = tempm.vertex(pmin.x + side_weight_x, pmin.y, 0);
